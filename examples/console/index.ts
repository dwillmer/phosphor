...
class Console extends Widget {
  ...
  private _vpos: number; // vertical position of next entry
  ...
  private _getImageHeight( image: Image ): number {
    return image.height+22;
  }
  ...
  /*private _imageDataToSrc( text: string ): string {
